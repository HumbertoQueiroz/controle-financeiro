...
React orientado a função para o frontend com typescript.

Estilização o tailwind.

Componentes prontos shadcn ui e radix-ui

Ícones o phosphor icon.
...
Docker, orientações: dentro da raiz do projeto terá uma pasta chamada docker-container, onde será armazenado o volume do projeto, ele será comitado junto com os arquivos do projeto

Fastify cria um servidor que controla rotas e requisições http.
...
Criar pasta Docs na raiz do projeto e documentar tudo que for importante.
