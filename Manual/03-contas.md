...
| **Paguei só uma parte** | Marque para informar um valor menor     |
| **Observação**          | Opcional                                |
...
Marcando **Paguei só uma parte**, o lançamento fica como **Parcial** e continua na lista
com o valor que falta. Você pode dar baixa quantas vezes precisar, cada uma com sua data e
observação.

O lançamento só sai do "em aberto" quando o total é atingido, e a data da baixa passa a ser
a do último pagamento — o que quitou.
